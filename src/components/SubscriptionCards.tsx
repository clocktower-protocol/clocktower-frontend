                        ...
                        <div key={uuidv4()} className="btn-group" style={{ display: "flex", justifyContent: "space-evenly" }}>
                            {props.isProvider && !props.isLink ?
                                <>
                                    ...
                                    <Button style={{ width: "100%", padding: '5px' }} type="submit" variant="outline-secondary" onClick={() => props.setLinkDisplayed?.(`${DOMAIN}/#/public_subscription/${subscriptionArray[i].subscription.id}`)}>Link</Button>
