...
// WalletConnect support is currently disabled. To re-enable:
// 1. Uncomment the walletConnect import below
// 2. Uncomment the walletConnect connector in the connectors array
// 3. Ensure @walletconnect/ethereum-provider is installed in package.json
