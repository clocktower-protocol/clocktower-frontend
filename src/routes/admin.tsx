...
import { ProviderSubLogsQueryResult, SubscriberSubLogsQueryResult, CallerLogsQueryResult } from '../types/subscription';
...
const Admin: React.FC = () => {
    ...
    const getAllAccounts = useCallback(async () => {
        ...
        const providerData = result.data as ProviderSubLogsQueryResult;
        const subscriberData = result2.data as SubscriberSubLogsQueryResult;
